		...
		<view class="box getheight">
			<view class="cu-bar search bg-white" style="height: 30px;">
				<view class="search-form round">
					...
					<input :adjust-position="false" type="text" :value="keyword" @input="inputChange" placeholder="产品编码/产品码/装箱码" confirm-type="search" />
				</view>
				...
				<view class="cu-list menu-avatar">
					<view class="cu-item" style="width: 100%;margin-top: 2px;padding:15rpx 0 15rpx 0;height: auto;">
						<view style="clear: both;width: 100%;" class="grid text-left col-2" data-target="Modal" data-number="item.number">
							...
							<view class="text-grey">产品名称:{{ item.FName }}</view>
