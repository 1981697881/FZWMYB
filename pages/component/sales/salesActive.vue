				    ...
				    success: function (res) {
						switch(res.tapIndex){
							...
							uni.navigateTo({
								...
								url: '../sales/pickingPassive?billNo='+item.FBillNo+'&tranType='+this.source+'&type=2&startDate='+this.start+'&endDate='+this.end+'&FDeptNumber='+item.FDeptNumber+'&FCustNumber='+item.FCustNumber+'&FCustName='+item.FCustName
							});
							break;
							case 1:
							uni.navigateTo({
